        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-brand-600 to-indigo-500 flex items-center justify-center text-white font-bold shadow-lg shadow-brand-500/10 group-hover:scale-105 transition-transform duration-200">
                QN
              </div>
        ...
        <div className="md:hidden border-t border-slate-800 bg-slate-950 px-2 pt-2 pb-4 space-y-1">
          ...
          <div className="pt-4 border-t border-slate-800 mt-2 flex items-center justify-between px-3">
            ...
            <div className="flex items-center gap-1">
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 transition-all border border-transparent"
                title="Toggle Theme"
              >
