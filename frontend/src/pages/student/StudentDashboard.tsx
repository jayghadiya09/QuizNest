      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 flex flex-col gap-8 animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="h-8 bg-slate-900 rounded-lg w-1/2"></div>
            <div className="h-64 bg-slate-900/60 rounded-2xl border border-slate-850"></div>
          </div>
        </div>
      </div>
    );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {attempts.filter((att: any) => att.status === 'COMPLETED' || att.completedAt || att.score !== undefined).length === 0 ? (
            ...
            <div className="space-y-4">
              {attempts
                .filter((att: any) => att.status === 'COMPLETED' || att.completedAt || att.score !== undefined)
                .map((att) => {
